<?php
/**
 * BasicBarbell_ functions and definitions.
 *
...
if ( ! function_exists( 'basic_barbell_setup' ) ) :
/**
 ...
 */
function basic_barbell_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on BasicBarbell_, use a find and replace
	 * to change 'basic-barbell' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'basic-barbell', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( 'basic_barbell_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'basic_barbell_setup' );
 ...
 */
function basic_barbell_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'basic_barbell_content_width', 640 );
}
add_action( 'after_setup_theme', 'basic_barbell_content_width', 0 );
 ...
 */
function basic_barbell_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'basic-barbell' ),
		'id'            => 'sidebar-1',
		'description'   => '',
 ...
 */
function basic_barbell_scripts() {
